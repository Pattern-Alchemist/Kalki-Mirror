...
import { openWhatsApp, WHATSAPP_LINKS } from '@/lib/utils/whatsapp';
...
export function WhatsAppCTA({
  ...
  return (
    <button
      onClick={() => openWhatsApp(msg)}
      className={`w-10 h-10 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/20 hover:scale-110 transition-transform ${className}`}
