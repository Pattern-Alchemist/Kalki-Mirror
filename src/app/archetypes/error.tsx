...
export default function ArchetypesError({
  ...
  useEffect(() => {
    console.error('[KALKI] Archetypes error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The Mahāvidyā matrix fractured during rendering. This is a transient disruption.
        </motion.p>
        ...
        >
          ...
          <Link href="/archetypes" className="ghost-cta text-sm">Browse Archetypes</Link>
        </motion.div>
      </div>
    </div>
  );
