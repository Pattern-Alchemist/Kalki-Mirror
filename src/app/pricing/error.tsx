...
export default function PricingError({
  ...
  useEffect(() => {
    console.error('[KALKI] Pricing error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The membership matrix fractured during rendering. This is a transient disruption.
        </motion.p>
        ...
        >
          ...
          <Link href="/pricing" className="ghost-cta text-sm">Membership</Link>
        </motion.div>
      </div>
    </div>
  );
