...
export default function ResearchError({
  ...
  useEffect(() => {
    console.error('[KALKI] Research error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The research archive encountered an error during rendering. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/research" className="ghost-cta text-sm">Research Archive</Link>
        </motion.div>
      </div>
    </div>
  );
