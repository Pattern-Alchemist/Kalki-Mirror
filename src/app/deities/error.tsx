...
export default function DeitiesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[KALKI] Deities error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The deity index encountered an error during rendering. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/deities" className="ghost-cta text-sm">Deity Pantheon</Link>
        </motion.div>
      </div>
    </div>
  );
