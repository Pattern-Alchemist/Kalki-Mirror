...
export default function BreathworkError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[KALKI] Breathwork error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The prāṇāyāma laboratory encountered an error. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/breathwork" className="ghost-cta text-sm">Prāṇāyāma Lab</Link>
        </motion.div>
      </div>
    </div>
  );
