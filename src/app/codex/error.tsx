...
export default function CodexError({
  ...
  useEffect(() => {
    console.error('[KALKI] Codex error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The codex system encountered an error during rendering. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/codex" className="ghost-cta text-sm">Sacred Codex</Link>
        </motion.div>
      </div>
    </div>
  );
