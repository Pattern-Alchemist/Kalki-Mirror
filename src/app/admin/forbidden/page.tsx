  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-transparent px-4">
      <div className="w-full max-w-sm space-y-6 text-center">
        ...
        <h1 className="text-2xl font-semibold text-[var(--aw-text)]">Access Denied</h1>
        ...
        <Link
          href="/"
          className="inline-block rounded-lg bg-zinc-800 px-4 py-2 text-sm text-[var(--aw-text-2)] transition hover:bg-zinc-700"
        >
          Return to Site
        </Link>
      </div>
