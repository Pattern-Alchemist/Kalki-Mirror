...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/aghoiri-tantra`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${base}/library`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${base}/redeem`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${base}/library`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${base}/aghoiri-tantra`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
