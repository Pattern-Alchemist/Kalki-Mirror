...
export default function MethodError({
  ...
  useEffect(() => {
    console.error('[KALKI] Method error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The Kalki Method encountered an error during rendering. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/method" className="ghost-cta text-sm">The Method</Link>
        </motion.div>
      </div>
    </div>
  );
