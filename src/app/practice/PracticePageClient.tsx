...
export default function PracticeLoggerPage({ siddhisByLevel }: { siddhisByLevel: Record<string, SiddhiOption[]> }) {
  const reduced = useNativeReducedMotion();
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-10 pt-32 pb-20">
          ...
          >
            ...
            <h1 className="hero-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
              The Practice{' '}
            <span style={{ display: 'block' }}>Floor</span>
            </h1>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                <AnimatePresence>
                  {siddhiDropdownOpen && (
                    ...
                    >
                      {Object.entries(siddhisByLevel).map(([level, siddhis]) => (
                        <div key={level}>
                          <button
                            type="button"
