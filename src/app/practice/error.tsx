...
export default function PracticeError({
  ...
  useEffect(() => {
    console.error('[KALKI] Practice error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          A practice instrument failed to render. Your session data is safe — this is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/practice" className="ghost-cta text-sm">Sādhana Instruments</Link>
        </motion.div>
      </div>
    </div>
  );
