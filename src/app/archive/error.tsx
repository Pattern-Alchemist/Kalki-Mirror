...
export default function ArchiveError({
  ...
  useEffect(() => {
    console.error('[KALKI] Archive error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          A folio failed to render. The archive matrix is intact — this is a transient disruption.
        </motion.p>
        ...
        >
          ...
          <Link href="/archive" className="ghost-cta text-sm">Browse Archive</Link>
        </motion.div>
      </div>
    </div>
  );
