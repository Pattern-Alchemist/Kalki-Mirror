...
export default function DossierError({
  ...
  useEffect(() => {
    console.error('[KALKI] Dossier error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The personal dossier system encountered an error. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/dossier" className="ghost-cta text-sm">My Dossier</Link>
        </motion.div>
      </div>
    </div>
  );
