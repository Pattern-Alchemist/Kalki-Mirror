...
export default function ConsultationsError({
  ...
  useEffect(() => {
    console.error('[KALKI] Consultations error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The consultation chamber failed to render. Your form data is safe — this is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/consultations" className="ghost-cta text-sm">Consultations</Link>
        </motion.div>
      </div>
    </div>
  );
