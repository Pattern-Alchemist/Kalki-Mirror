...
export default function SequenceError({
  ...
  useEffect(() => {
    console.error('[KALKI] Sequence error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The sequence matrix encountered an error during rendering. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/sequences" className="ghost-cta text-sm">Sequence Index</Link>
        </motion.div>
      </div>
    </div>
  );
