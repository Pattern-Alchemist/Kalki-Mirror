...
export default function GlossaryError({
  ...
  useEffect(() => {
    console.error('[KALKI] Glossary error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The glossary index encountered an error during rendering. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/glossary" className="ghost-cta text-sm">Glossary</Link>
        </motion.div>
      </div>
    </div>
  );
