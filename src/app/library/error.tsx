...
export default function LibraryError({
  ...
  useEffect(() => {
    console.error('[KALKI] Library error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-deep-black flex items-center justify-center px-6">
      <div className="relative z-10 max-w-md text-center space-y-6">
        ...
        >
          The Sādhana Library encountered an error during rendering. This is transient.
        </motion.p>
        ...
        >
          ...
          <Link href="/library" className="ghost-cta text-sm">Sādhana Library</Link>
        </motion.div>
      </div>
    </div>
  );
